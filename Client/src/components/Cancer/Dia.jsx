 ...
 const Dia = () => {
  ...
  const classes=useStyle();
    return (<>
          ...
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsHcw5ghUl_jyG1rDynDANT_pqdATQdgnddw&usqp=CAU" alt='gh' width={500} height={300} style={{'borderRadius':'15px'}}/>
          </div>

          <div className={classes.sk} >
          <img src="https://sa1s3optim.patientpop.com/assets/images/provider/photos/2120602.jpg"alt='gh' width={490} height={300} style={{'borderRadius':'15px'}}/>
          </div>
        <div className={classes.component}> <div className={classes.com}>
        <h1 className={classes.h1} >Predict your chance of having Diabetes</h1>
