        ...
        <div className="work-container container">
          ...
          <div className="row">
            ...
            <center>
               ...
               <Button className={classes.viewbtn} style={{marginTop:50,marginLeft:10}} variant="contained" size="large" 
               onClick={() => history.push("/Another")}
               >Available Disease </Button>
               <Button className={classes.viewbtn} style={{marginTop:50,marginLeft:200}} variant="contained" size="large" 
